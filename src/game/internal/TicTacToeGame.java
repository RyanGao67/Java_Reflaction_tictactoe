...
public class TicTacToeGame implements Game {
    ...
    TicTacToeGame(Board board,
        ...
        this.board = board;        this.printer = printer;        this.players = Arrays.asList(humanPlayer, computerPlayer);
    }
    public void startGame() {
        ...
        if (winner != Sign.EMPTY) {            System.out.println(String.format("Winner is : %s", player.getPlayerName()));        }
        else {            System.out.println("Game over! Nobody won.");        }
    }
}